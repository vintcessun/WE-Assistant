...
withDefaults(defineProps<{ height?: number }>(), { height: 45 })
</script>

<template>
  <header class="qq-header" :style="{ '--qq-header-height': height + 'px' }">
    <div class="qq-header__btn-bar">
      <span class="qq-header__btn red"></span>
...
.qq-header {
  ...
  .qq-header__title {
    text-align: center;
    font-weight: bold;
    line-height: var(--qq-header-height);
